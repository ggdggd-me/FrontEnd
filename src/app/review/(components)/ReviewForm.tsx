        ...
        <section className="fixed w-full h-full top-0 left-0 flex justify-center items-center bg-[rgb(0,0,0)]/60 z-[100]">
          <div className="bg-white p-[40px] rounded-[8px]">
            ...
            <form className="text-black flex flex-col gap-[28px]">
              ...
              <div className={style}>
                <label className="text-[24px] font-bold" htmlFor="title">
                  제목
                </label>
                <input
              ...
              <div className={style}>
                <label className="text-[24px] font-bold" htmlFor="user">
                  작성자
                </label>
                <div className="flex gap-[24px] ">
                  ...
                  />
                  <input
                    className={`w-[380px] pl-[16px] pr-[8px] ${inputStyle}`}
                    type="number"
                    min="0"
                    id="user"
                    name="duration"
              ...
              <button
                className="bg-blue600 text-white px-[30px] py-[16px] rounded-full mx-auto text-[24px] font-semibold"
                onClick={onSubmit}
              >
                작성 완료
              </button>
