...
export default function DownloadModal({ setModalState }: Props) {
  useEffect(() => {
  ...
  return (
    <section className="fixed w-full h-full top-0 left-0 flex justify-center items-end bg-[rgb(0,0,0)]/60 z-[100]">
      <article className="w-full max-w-[1920px] flex flex-col items-center bg-white gap-[52px] relative animate-[modalOpen_350ms_ease-in]">
        <h2 className="text-[48px] text-bold mt-[94px]">
